...
cd /mnt/scgc/simon/microg2p/analyses/JdF_analysis/analysis/JdF_GORG_RNA_recruit

nextflow run BigelowLab/gorg-classifier \
-profile charlie \
--seqs '/mnt/scgc/simon/microg2p/JdF_analysis/Data/JdF_metatranscriptomic_reads/*.fastq.gz' \
--mode local \
...
--outdir /mnt/scgc/simon/microg2p/analyses/JdF_analysis/analysis/JdF_GORG_RNA_recruit