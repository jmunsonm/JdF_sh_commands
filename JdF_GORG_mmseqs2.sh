...
#PBS -o /mnt/scgc/simon/microg2p/JdF_analysis/sh_files/out/JdF_GORG_mmseqs2.out
...
faa=/mnt/scgc_nfs/ref/gorg_classifier_2022/jdf/jdf_v_gtdb_R207.proteins.faa
db=${mmseqdir}/${name}.db
